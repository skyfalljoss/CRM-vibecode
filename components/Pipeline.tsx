...
const Pipeline: React.FC<PipelineProps> = ({ leads, stages, onMoveLead, onSelectLead }) => {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="glass-card flex items-center rounded-lg px-2 py-1">
            ...
            <select className="bg-transparent border-none text-[10px] outline-none text-zinc-300">
              <option>All Sources</option>
              <option>Referral</option>
              <option>Website</option>
            </select>
          </div>
          <button className="glass-card p-2 rounded-lg hover:bg-white/5 text-zinc-400">
            <Search size={16} />
          </button>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 glass-panel rounded-2xl p-2 flex flex-col gap-2 min-h-[300px]">
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="w-5 h-5 rounded-full overflow-hidden border border-white/10 shrink-0">
                        <img src={`https://picsum.photos/seed/${lead.id}/20/20`} alt="" />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div className="flex items-center gap-1 text-zinc-300 font-medium">
                        ...
                        <span className="text-xs">{(lead.value / 1000).toFixed(1)}k</span>
                      </div>
                ...
                <button className="flex items-center gap-2 w-full px-3 py-2 text-[10px] text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.02] rounded-lg transition-all border border-dashed border-white/5 mt-auto">
                  <Plus size={12} />
                  <span>Add Deal</span>
                </button>
              </div>
